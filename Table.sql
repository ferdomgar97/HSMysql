...
begin
    ...
    /* Mirar si se puede restringir clase */
...
/* Disparadores */
delimiter $$ 
drop trigger if exists t_nullDescriptionCard $$ /* No funciona como debe */
...
*/
delimiter $$
drop trigger if exists t_heroeLimiter $$ /* Intentar añadir un heroe*/
